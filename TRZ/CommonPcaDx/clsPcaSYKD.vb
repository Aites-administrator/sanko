...
#Region "パブリック"
  ...
  ''' 原単価
  ''' </summary>
  Public WriteOnly Property 原単価 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "GenTanka", value)
    End Set
  End Property
  ...
  ''' 原価金額
  ''' </summary>
  Public WriteOnly Property 原価金額 As String
    Set(value As String)
  ...
  ''' 粗利益
  ''' </summary>
  Public WriteOnly Property 粗利益 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "Ararieki", value)
    End Set
  End Property
  ...
  ''' 売上項目1
  ''' </summary>
  Public WriteOnly Property 売上項目1 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "UriageKomoku1", value)
    End Set
  End Property
  ...
  ''' 売上項目2
  ''' </summary>
  Public WriteOnly Property 売上項目2 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "UriageKomoku2", value)
    End Set
  End Property
  ...
  ''' 売上項目3
  ''' </summary>
  Public WriteOnly Property 売上項目3 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "UriageKomoku3", value)
    End Set
  End Property
  ...
  ''' 売上税種別
  ''' </summary>
  Public WriteOnly Property 売上税種別 As String
    Set(value As String)
  ...
  ''' 原価税種別
  ''' </summary>
  Public WriteOnly Property 原価税種別 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "GenkaZeiSyubetsu", value)
    End Set
  End Property
  ...
  ''' 原価税率
  ''' </summary>
  Public WriteOnly Property 原価税率 As String
    Set(value As String)
      Call ComSetDictionaryVal(_PostData, "GenkaZeiRitsu", value)
    End Set
  End Property
  ...
  ''' 商品名２
  ''' </summary>
  Public WriteOnly Property 商品名2 As String
    Set(value As String)
